...
export function HomePage({ onStartAudit }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--color-bg-primary)] to-[var(--color-bg-secondary)] text-white overflow-hidden">
      ...
      {/* Footer */}
      <footer className="border-t border-[var(--color-border)] py-8 px-4 bg-[var(--color-bg-secondary)]/50" role="contentinfo">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Velox. Helping websites capture their revenue potential.
            </p>
            <nav className="flex gap-6 text-gray-400 text-sm" aria-label="Footer navigation">
